    ...
    >
      <CardContent className="p-4 flex gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          {summary && (
            <p className="text-muted-foreground text-sm line-clamp-2 mb-2">{summary}</p>
          )}
          
          {type === ContentItemType.Quote && content && (
            <blockquote className="pl-3 border-l-2 border-muted-foreground/40 italic text-muted-foreground mb-2">
              {content}
            </blockquote>
          )}
