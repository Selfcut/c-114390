...
const Library = () => {
  ...
  return (
    <main className="container mx-auto py-8">
      ...
      <div className="bg-card rounded-lg p-4 mb-8 shadow-md border border-border">
      ...
      <div className={`grid ${viewMode === 'grid' ? 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3' : 'grid-cols-1'} gap-4 stagger-fade`}>
        {filteredEntries.length > 0 ? (
          ...
          <div className="bg-card rounded-lg p-8 text-center col-span-full border border-border">
      ...
      <div className="mt-8 bg-card rounded-lg p-6 border border-border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 stagger-fade">
          <div className="bg-muted p-4 rounded-lg hover-lift cursor-pointer">
